...
class LoginSignup extends Component {
  ...
  submitHandler = (e) => {
    if (
      this.state.login_email === "haseebzaidi123@gmail.com" &&
      this.state.login_password === "haseeb123"
    ) {
      e.preventDefault();
      console.log("works");
    }
  ...
  validate(
    ...
    if (
      this.state.touched.login_email &&
      !/^[a-zA-Z0-9]+@+[a-zA-Z0-9]+.+[A-z]/.test(login_email)
    ) {
      errors.login_email =
    ...
    if (this.state.touched.signup_username && signup_username.length < 3)
      ...
      this.state.touched.signup_username &&
      signup_username.length < 10 &&
      this.state.touched.signup_username &&
    ...
    if (
      this.state.touched.signup_email &&
      !/^[a-zA-Z0-9]+@+[a-zA-Z0-9]+.+[A-z]/.test(signup_email)
    )
      errors.signup_email =
        "Please enter a valid email with an @ and a valid domain";
    else if (
    ...
    if (this.state.touched.login_password && login_password.length < 6)
      ...
      this.state.touched.login_password &&
      login_password.length < 20 &&
      this.state.touched.login_password &&
      login_password.length > 6
    )
    ...
    if (this.state.touched.signup_password && signup_password.length < 6)
      ...
      this.state.touched.signup_password &&
      signup_password.length < 20 &&
      this.state.touched.signup_password &&
      signup_password.length > 6
    )
      errors.signup_password = "";

    if (
      this.state.touched.signup_confirmpassword &&
      signup_confirmpassword !== signup_password
    )
  ...
  render() {
    const errors = this.validate(
      ...
      this.state.signup_confirmpassword
    );
        ...
        <div id="ls_container">
          <div id="ls_content_container">
            ...
            <div id="login_container" className="active">
              <form>
                <div>
                  <label htmlFor="email" className="ls_label">
                    Email
                  </label>
                  <div>
                    <input
                ...
                <div>
                  <label htmlFor="password" className="ls_label">
                    Password
                  </label>
                  <div>
                    <input
            ...
            <div id="signup_container">
              <form>
                <div>
                  <label htmlFor="username" className="ls_label">
                    Username
                  </label>
                  <div>
                    <input
                ...
                <div>
                  <label htmlFor="confirm_password" className="ls_label">
                    Confirm Password
                  </label>
                  <div>
                    <input
                      ...
                      onBlur={(e) => this.inputOnBlur(e)}
                    />
                    <p className="form_feedback">
                      {errors.signup_confirmpassword}
                    </p>
                  </div>
                </div>
                <div className="submit_btn_container">
                  <button type="submit" disabled={true} className="submit_btn">
                    Submit
                  </button>
                </div>
              </form>
